...
#' Find the convex hull of a set of points in 3D.
#'
...
#' dimFace(pts) # a polygon
#' convexHull3D(pts, classify = TRUE) # a polyhedron
...
#' finalize3D()
convexHull3D <- function(pts, classify = FALSE, addR3 = FALSE) {
