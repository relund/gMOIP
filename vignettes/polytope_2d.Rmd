...
vignette: >
  %\VignetteIndexEntry{polytope_2d}
...
With `gMOIP` you can make 2D plots of the the polyeder/feasible region/solution space of a linear programming (LP), integer linear programming (ILP) model, or mixed integer linear programming (MILP) model. This vignette gives examples on how to make plots given a model with two variables. 
