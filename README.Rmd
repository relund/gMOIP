...
Make 2D plots of the polyeder of a linear programming (LP), integer programming (IP) model,
or mixed integer linear programming (MILP) model, 
including integer points, ranges and iso profit curve. Can also make a plot of a bi-objective criterion
