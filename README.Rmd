...
To view the 3D plot you have to view the [html page](http://htmlpreview.github.io/?https://github.com/relund/gMOIP/blob/master/README.html) of this markdown

```{r, webgl=TRUE, include=TRUE}
# LP model
